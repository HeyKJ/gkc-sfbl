...
const DEFAULT_OPTION = { skipHeader: false, encoding: 'utf8', type: 'text', quote: '', delimiter: ',' }
...
module.exports = async function (filePath = String, yourOption = DEFAULT_OPTION, cb = undefined) {
  ...
  while ((line = lineReader.next()) !== false) {
    ...
    try {
      ...
      if (option.type === 'csv') {
        const [fields] = await util.promisify(csv.parse)(line, { quote, delimiter })
        data.fields = fields
      }
    } catch (e) {
      error = e
